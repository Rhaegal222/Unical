...
'''
    ...
    Rispetto all'esempio che viene fatto tradizionalmente in ogni edizione del corso:
     ...
     - Vi ho lasciato il codice della soluzione A e della soluzione B per ricordarvi le cose che NON SI DEVONO fare, ma la traccia sarà basata sulla soluzione C.
